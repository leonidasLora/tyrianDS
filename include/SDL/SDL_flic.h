/*
 * Based on SDL_flic by Andre de Leiradella
 * Changed by Chui
*/
...
Play a flic file.
*/
int FLI_Play(SDL_Surface *screen, SDL_Rect *pos, char *flic_name, int mem, char *music_na, SDL_Surface *font, char *text, int loop);
...
extern void FLI_InitDefaultFont(void);
extern void FLI_FreeDefaultFont(void);
